...
private:
    ...
    void UniquKey(Node* p, vector <string> &mas, string Brand, string Model, bool &flag1){
        if (p != nullptr and flag1) {
            UniquKey(p->left, mas, Brand, Model, flag1);
            UniquKey(p->right,mas, Brand, Model, flag1);
